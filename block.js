...
var Blockchain = class Blockchain {
      ...
      isChainSynch(length) {
        if(this.isChainValid() && this.chain.getLength() == length){
          //this.chain.inSynch = true;
          log("4444444444444444     CHAIN IS SYNCH at block "+this.chain.getLength()+"    4444444444444444444");
          return true;
        }else{
          log("55555555555555555     CHAIN IS NOT SYNCH at block "+this.chain.getLength()+"     5555555555555555555");
          return false;
        }
      }
