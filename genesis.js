...
var firstResponder = function(initialRF,secondRF,thirdRF){
 initialInvol = initialRF;
 console.log("initialInvol is set ");
 secondInvol = secondRF;
 thirdInvol = thirdRF;
 console.log("all set lets call one ...");
 initialInvol(thirdInvol).then(function(txHsh){
   thirdInvol(txHsh);
 });
}
